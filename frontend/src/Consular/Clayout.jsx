                       ...
                       <div className="offcanvas offcanvas-start" data-bs-scroll="true" tabIndex="-1" id="offcanvasWithBothOptions" aria-labelledby="offcanvasWithBothOptionsLabel">
                         ...
                         <div className="offcanvas-body">
                            <ul>
                             ...
                             <li><Link to={'addenq'}><i class="fa-solid fa-comment-dots text-danger"></i> Add Enquiries</Link></li>
                   ...
                   <div className="col-sm-1" >
                      <div class="dropdown ">
                        ...
                        <ul class="dropdown-menu border-warning">
                          ...
                          <li><Link class="dropdown-item" href="#" to={'profile'}><i class="fa-regular fa-address-card text-warning me-3"></i> Profile</Link></li>
